...
import {faBuilding, faHammer, faLocationPin,
      faMicroscope, faPills, faScaleBalanced,
      faScrewdriverWrench, faStethoscope,
      faUserPen, faUserPlus} from "@fortawesome/free-solid-svg-icons"
...
export default class SideBar extends React.Component<Props> {
    ...
    render() {
        return (
            <div className={`bg-stone-900 min-h-full h-screen ${this.props.className}`}>
                <Logo />
                <div className=''>
