...
// import { $history } from '../../Services/State';
type Props = {
    selected: "Dashboard" | "Create Patient" | "View Patients" | "Edit Assessment" | "Edit Vitals" | "Edit Medications" | "Add/Remove Admins" | "Edit Settings Raw" | "Edit I/O"
}
        ...
        return (
            <div className='grid grid-areas-main min-h-screen grid-cols-twoSections grid-rows-threeSections'>
                ...
                <SideNav className="grid-in-sideBar flex flex-col gap-2">
                    ...
                    <SideNavHeader admin href="/admin/scales/edit" className={this.props.selected === "Edit I/O" ? this.selectedStyle : null}>Edit Scales</SideNavHeader>
