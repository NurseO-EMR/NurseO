...
export function BasicInfoStage(props: Props) {
    ...
    return (
        <BaseStage {...props} title="Let`s collect some basic information about your patient" icon={faIdCard} onNext={onNextClickHandler}>
                ...
                <Input label="Height" type="text" step={0.5} onChange={e=>setHeight(e.currentTarget.value)} value={height}/>
                <Input label="Weight" type="text" step={0.5} onChange={e=>setWeight(e.currentTarget.value)} value={weight}/> 
