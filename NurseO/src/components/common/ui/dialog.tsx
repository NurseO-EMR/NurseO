...
const DialogContent = React.forwardRef<
  ...
  >(({ className, children, ...props }, ref) => {
    const { themeName } = React.useContext(GlobalContext)
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      "text-lg font-semibold leading-none tracking-tight border-b-2 pb-2 text-primary",
      className
    )}
    {...props}
  />
