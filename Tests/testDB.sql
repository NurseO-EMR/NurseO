...
(45, 'Skin Temperature1', 'options', 0, 36),
...
(85, 'Skin Temperature2', 'options', 0, 68),
...
(28, 'Pain', '/assets/FACES_English_Black.jpg', 'studentVitalsReport', 'pain scale from 0 to 10'),
...
INSERT INTO `Medication` (`brand_name`, `generic_name`, `narcoti_count_needed`) VALUES
('', 'glucose tablets', 0),
('Celestone', 'betamethasone', 0),
('Humulin R ', 'insulin regular', 0),
('D10 NS + 40 KCl', '10% dextrose in 0.9% sodium chloride with 40 mEq potassium chloride', 0),
('Ciprodex', 'Ciprofloxacin / Dexamethasone', 0),
('Lopressor', 'metoprolol', 0),
('', '50% Dextrose', 0),
('Percocet', 'oxycodone / acetaminophen', 0),
(' ', '5% dextrose in 0.9% sodium chloride', 0),
('', 'prenatal multivitamin', 0),
('', 'morphine sulfate ', 0),
('', 'multivitamin', 0),
('Augmentin', 'amoxicillin / clavulanate potassium ', 0),
('Buspar', 'buspirone', 0),
('', '5% dextrose in 0.45% sodium chloride with 20 mEq potassium chloride', 0),
('Lantus', 'insulin glargine', 0),
('Bicitra', 'sodium citrate / citric acid', 0),
('Nitrostat', 'nitroglycerin', 0),
('Normal Saline3', '0.9% sodium chlorid', 1),
('1/2 NS', '0.45% sodium chloride ', 0),
('Ortho Tri-Cyclen', 'ethinyl estradiol and norgestimate', 0),
('Dermoplast', 'benzocaine / menthol topical spray', 0),
('Narcan', 'naloxone hydrochloride', 0),
('Zyprexa', 'olanzapine', 0),
(' D5 1/2NS', '5% dextrose in 0.45% sodium chloride', 0),
('Motrin', 'ibuprofen', 0),
('Serevent Diskus', 'salmeterol', 0),
('', '5% dextrose', 0),
('Pitocin', 'oxytocin', 0),
('Diastat ', 'diazepam', 0),
('Colace', 'docusate sodium', 0),
('', '10% dextrose', 0),
('NPH', 'insulin isophane', 0),
('Reglan', 'metodopramide', 0),
(' Cogentin', 'benztropine', 0),
('', 'Nitr Derm', 0),
('Prozac', 'fluoxetine', 0),
('Humalog', 'insulin lispro', 0),
('Versed', 'midazolam', 0),
('Erythromycin', 'erythromycin base/sulfisoxazole', 0),
('', 'sennosides-docusate sodium', 0),
('', 'magnesium sulfate', 0),
('Rocephin', 'ceftriaxone', 0),
('Pepcid', 'famotidine', 0),
('', 'albuterol sulfate', 0),
('Benadryl', 'diphenhydramine', 0),
('', 'melatonin', 0),
('Lasix', 'furosemide', 0),
('Amoxil', 'amoxillin', 0),
('Lactated Ringers', 'LR', 0),
('Aspirin', 'acetylsalicylic acid', 0),
('Synthroid', 'levothyroxine', 0),
('Bicillin', 'penicillin G ', 0),
('Zofran', 'ondansetron', 0),
('Glucagen', 'glucagon', 0),
('NS + 40 KCl', '0.9% sodium chloride with 40 mEq potassium chloride', 0),
('Suboxone', 'buprenorphine', 0),
('Desyrel', 'trazodone', 0),
('K-Dur', 'potassium chloride', 0),
('Banana Bag', '100 mg Thiamine, 1 mg Folic Acid, Low Dose Multivitamin, 3 grams Magnesium Sulfate', 0),
('', 'thiamine HCL', 0),
('', 'sodium citrate', 0),
('Lovenox', 'enoxaparin sodium ', 0),
('Methergin', 'methylergonovine maleate', 0),
('Humulin R in Normal Saline ', 'insulin regular in 0.9% sodium chloride', 0),
('Coumadin', 'warfarin', 0),
('', 'Calcium Gluconate', 0),
('Nubain', 'nalbuphine hydrochloride', 0),
('Cytotec', 'misoprostol ', 0),
('Ativan', 'lorazepam', 0),
('Tylenol', 'acetaminophen', 0),
('Ancef', 'cefazolin sodium ', 0),
('ergergre', 'rgergreger', 0),
('efewefwfwe', 'ghgug', 0),
('mohammed b', 'mohammed c', 0);
COMMIT;
